...
@Component({
  selector: 'App-User',
  templateUrl: './FinalReportComment.component.html',
  styleUrls: ['./FinalReportComment.component.css'],
  providers: [StudentService, BottomToastsManager]
})
export class FinalReportCommentComponent extends CommonComponent<StudentEntity> {
