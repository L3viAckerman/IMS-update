...
@Component({
  selector: 'App-User',
  templateUrl: './PeriodReportComment.component.html',
  styleUrls: ['./PeriodReportComment.component.css'],
  providers: [StudentService, BottomToastsManager]
})
export class PeriodReportCommentComponent extends CommonComponent<StudentEntity> {
