...
@Component({
  selector: 'App-User',
  templateUrl: './NewStudentOfCompany.component.html',
  styleUrls: ['./NewStudentOfCompany.component.css'],
  providers: [StudentService, BottomToastsManager]
})
export class NewStudentOfCompanyComponent extends CommonComponent<StudentEntity> {
