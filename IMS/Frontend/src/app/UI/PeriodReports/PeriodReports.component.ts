...
@Component({
  selector: 'App-User',
  templateUrl: './PeriodReports.component.html',
  styleUrls: ['./PeriodReports.component.css'],
  providers: [StudentService, BottomToastsManager]
})
export class PeriodReportsComponent extends CommonComponent<StudentEntity> {
